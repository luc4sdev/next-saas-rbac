                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell className="text-right">{billing.projects.price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })} ({billing.projects.unit.toLocaleString('en-US', { style: 'currency', currency: 'USD' })} each)</TableCell>
                            </TableRow>

                            <TableRow>
                                <TableCell>Amount of seats</TableCell>
                                <TableCell className="text-right">{billing.seats.amount}</TableCell>
                                <TableCell className="text-right">{billing.seats.price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })} ({billing.seats.unit.toLocaleString('en-US', { style: 'currency', currency: 'USD' })} each)</TableCell>
                            </TableRow>
                        </TableBody>
                        <TableFooter>
                            <TableRow>
                                ...
                                <TableCell className="text-right">{billing.total.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</TableCell>
                            </TableRow>
                        </TableFooter>
                    </Table>
                </CardContent>
